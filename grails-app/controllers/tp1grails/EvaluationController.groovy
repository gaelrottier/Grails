...
class EvaluationController {
    ...
    def save(Evaluation evaluationInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'evaluation.label', default: 'tp1grails.Evaluation'), evaluationInstance.id])
    ...
    def update(Evaluation evaluationInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'evaluation.label', default: 'tp1grails.Evaluation'), evaluationInstance.id])
                redirect evaluationInstance
            }
    ...
    def delete(Evaluation evaluationInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'evaluation.label', default: 'tp1grails.Evaluation'), evaluationInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'evaluation.label', default: 'tp1grails.Evaluation'), params.id])
                redirect action: "index", method: "GET"
            }
