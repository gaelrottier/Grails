...
class GroupeController {
    ...
    def save(Groupe groupeInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'groupe.label', default: 'tp1grails.Groupe'), groupeInstance.id])
    ...
    def update(Groupe groupeInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'groupe.label', default: 'tp1grails.Groupe'), groupeInstance.id])
                redirect groupeInstance
            }
    ...
    def delete(Groupe groupeInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'groupe.label', default: 'tp1grails.Groupe'), groupeInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'groupe.label', default: 'tp1grails.Groupe'), params.id])
                redirect action: "index", method: "GET"
            }
