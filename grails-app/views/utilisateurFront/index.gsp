...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><a class="edit"
               href="${createLink(mapping: "user", action: "show", id: session.utilisateur.id)}"><g:message
                    code="utilisateur.my.profile.label"/></a></li>
    </ul>
</div>
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="prenom"
                              title="${message(code: 'utilisateur.prenom.label', default: 'Prénom')}"/>
