...
import tp1grails.POIController
...
class POIControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        response.redirectedUrl == '/tp1grails.POI/show/1'
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        then: "A 404 error is returned"
        response.redirectedUrl == '/tp1grails.POI/index'
        flash.message != null
        ...
        response.redirectedUrl == "/tp1grails.POI/show/$POI.id"
        flash.message != null
    }
